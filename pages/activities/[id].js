    ...
    <div>
      ...
      <div className="px-20 pt-20 pb-10 md:px-20 py-14">
        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="bg-white rounded-xl pl-12 pt-5 space-y-4">
            <p className="text-gray-600">
              <span className="font-medium">🏅 :</span>{" "}
              {activity.sport_category?.name || "Tidak tersedia"}
            </p>
            <p className="text-gray-600">
              <span className="font-medium">📅 :</span>{" "}
              {formattedDate}
          ...
          <div className="bg-[#0E3B61] w-1/4 rounded-3xl">
            <p className="font-bold text-2xl text-white pl-4 pt-4">Rp.{" "}{activity.price?.toLocaleString("id-ID")}
